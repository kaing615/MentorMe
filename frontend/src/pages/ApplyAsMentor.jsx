      ...
      {currentStep === 1 && (
        <div title="About Form" className="flex flex-col">
          <div title="Upload your profile picture" className="flex flex-col mt-[-5px]">
            <label className="text-xl font-medium text-md pl-100 pb-2">Photo</label>
          ...
          <div title="Hold input fields for mentor details" className="flex flex-col pl-100">
            ...
            <div alt = "Job title and location" className = "flex flex-row mb-4 gap-6">
                <input type = "text" placeholder = "Job Title" className="p-2 border border-gray-300 rounded-[9px] h-[52px] w-[330px] focus:outline-none" />
                <input type = "text" placeholder = "Location" className="p-2 border border-gray-300 rounded-[9px] h-[52px] w-[345px] focus:outline-none" />
            </div>
      ...
      {currentStep === 2 && (
        <div title="Profile Form" className="flex flex-col pl-100 transition-all duration-500 ease-in-out">
          <div>
            ...
            <label className="block mb-1 text-lg font-medium text-left">Categories</label>
            ...
            <label className="block text-lg font-medium text-left">Skills</label>
            <div className="mb-0">
              <input 
                type="text" 
            ...
            <label className="block mt-2 text-lg font-medium text-left">Bio</label>
            <div className="mb-0">
              <textarea 
            ...
            <label className="block mt-2 text-lg font-medium text-left">LinkedIn Profile URL</label>
            <div className="mb-4">
              <input 
                type="text" 
