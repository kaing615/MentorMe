      ...
      <div className="w-1/2">
        ...
        <div alt="Sign Up Form" className="flex flex-col">
          ...
          >
            <button
              onClick={onFinish}
              className="flex items-center bg-slate-950 text-left py-3 px-6 mb-3.5 gap-2 rounded-lg border-0 cursor-pointer hover:bg-slate-800 transition-colors duration-200"
            >
