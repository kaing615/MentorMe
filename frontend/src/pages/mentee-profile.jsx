...
const MenteeProfile = () => {
  ...
  const handleSaveImage = () => {
    if (profileImage) {
      // Auto update sidebar avatar when image is saved
            ...
            <form className="space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="flex items-center gap-2 text-sm font-medium text-gray-700 mb-1">
                      <img src={googleImg} alt="LinkedIn" className="w-5 h-5" />
                      LinkedIn
                    </label>
                    <input
                      type="url"
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                {!selectedChatMentor ? (
                  <>
                    ...
                    {generateMenteeMessages(0).length === 0 && (
                      <div className="text-center py-12">
                        <div className="flex flex-col items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-gray-400">
                              Start a conversation with a mentor to get help
                      ...
                      {chatMessages.map((msg) => (
                        <div
                          ...
                          className={`flex gap-3 ${
                            msg.senderId === "mentee" ? "flex-row-reverse" : ""
                          }`}
                        >
                          <img
                            src={msg.avatar}
