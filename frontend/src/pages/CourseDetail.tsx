...
const CourseDetail = () => {
  ...
  const testimonialRef = useRef<any>(null); // <- KHÔNG comment, vì bên dưới có dùng
            ...
            >
              ...
              <div className="flex flex-col flex-1 min-w-0">
                ...
                <div className="flex flex-wrap gap-1">
                  {(() => {
                    const langs = courseData.language;
              ...
              <div className="flex flex-col flex-1 min-w-0">
                ...
                <div className="text-gray-600 text-sm leading-relaxed">
                  {(() => {
                    ...
                    const objectives = courseData.keyLearningObjectives;
