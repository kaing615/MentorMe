...
const CourseDetail = () => {
  ...
  const discountPrice =
    ...
    typeof courseData.discount === "number"
          ...
          >
            ...
            >
              <span className="text-3xl font-bold text-black">
                ${!isNaN(discountPrice) ? discountPrice.toFixed(1) : "0.0"}
              </span>
                ...
                {relatedCourses.map((course, idx) => (
                  ...
                  >
                    ...
                    <div className="text-sm text-slate-600">
                      By {course.mentor?.userName || course.mentor?.firstName}
                    </div>
                    ...
                    <div className="font-bold flex flex-row text-xl mt-1 gap-1">
                      <div title="discount">
                        $
                        {course.price -
                          (course.price * (course.discount / 100)).toFixed(1)}
                      </div>
