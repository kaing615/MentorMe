...
// ===== PUBLIC AUTH =====
if (typeof U.signUp !== "function")
  throw new Error("user.controller.js is missing: signUp");
if (typeof U.signIn !== "function")
  throw new Error("user.controller.js is missing: signIn");
if (typeof U.signUpMentor !== "function")
  throw new Error("user.controller.js is missing: signUpMentor");
...
// ===== PROTECTED USER =====
const maybeUpload = upload?.single
  ? upload.single("avatar")
  : (req, _res, next) => next();
