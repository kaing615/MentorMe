...
router.get("/mentor", tokenMiddleware.auth, bookingController.getBookingsOfMentor);
router.get("/mentee", tokenMiddleware.auth, bookingController.getBookingsOfMentee);
