...
|------|-----|--------------|
| Primary | `#0E7490` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary | `#06B6D4` | `--color-secondary` |
| Accent/CTA | `#0E7490` | `--color-accent` |
| Background | `#F0FBFC` | `--color-background` |
| Foreground | `#102A32` | `--color-foreground` |
| Muted | `#E3F5F7` | `--color-muted` |
| Border | `#C7E5E9` | `--color-border` |
| Destructive | `#C0394B` | `--color-destructive` |
| Ring | `#0E7490` | `--color-ring` |

**Color Notes:** Light cyan surfaces + accessible deep-cyan actions
